...
{   
    ...
    [MaxLength(80,ErrorMessage = "O nomen deve ter no máximo 80 cacteres")]
    
    public  string Name { get; set; }
    
    [Required(ErrorMessage = "O email não pode ser vazio")]
    [MinLength(10,ErrorMessage = "O email dever ter no mínimo 10 caracteres")]
    [MaxLength(180,ErrorMessage = "O email deve ter maximo 180 caracteres")]
    ...
    [MaxLength(180,ErrorMessage = "A senha deve ter no mínimo 180 caracteres")]
